                ...
                <div class="flexboxcontainer">
                    ...
                    <div class="container flexboxitem flexboxitem2">
                     ...
                     <!-- <div class="container flexboxitem flexboxitem3">
                        <h2>Summarize Report</h2>
                        <form action="insurance.html" method="POST" enctype=multipart/form-data>
...
async mounted() {
   ...
   console.log(data)
    ...
    let res1 = await axios.get('http://localhost:8080/getInsurances');

    let data1 = res1.data;
    this.insurancedatas = data1;
    console.log("this is insurance data")
   console.log(data1)
